...
module Make (C : sig
  ...
  module AArch64Cst = SymbConstant.Make (Int64Scalar) (AArch64PteVal) (AArch64SysReg) (AArch64I)
  module NoCst = SymbConstant.Make (Int64Scalar) (PteVal.No) (SysReg.No) (AArch64I)
