Check GCSPOPM dot output under shadowstack.
  ...
  $ herd7 -variant shadowstack GCSPOPM.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check GCSPUSHM dot output under shadowstack.
  ...
  $ herd7 -variant shadowstack GCSPUSHM.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check BL dot output under shadowstack.
  ...
  $ herd7 -variant shadowstack BL.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check RET dot output under shadowstack.
  ...
  $ herd7 -variant shadowstack RET.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check GCSPOPM dot output under shadowstack,vmsa.
  ...
  $ herd7 -variant shadowstack,vmsa GCSPOPM.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check GCSPUSHM dot output under shadowstack,vmsa.
  ...
  $ herd7 -variant shadowstack,vmsa GCSPUSHM.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check BL dot output under shadowstack,vmsa.
  ...
  $ herd7 -variant shadowstack,vmsa BL.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
...
Check RET dot output under shadowstack,vmsa.
  ...
  $ herd7 -variant shadowstack,vmsa RET.litmus -show all -showevents all -showinitwrites false -o - | sed '/^Time/d'
